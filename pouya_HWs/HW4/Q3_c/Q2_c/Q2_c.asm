...
; Q3_c.asm
;
; Created: 11/25/2018 04:26:17 ب.ظ
; Author : mpouya
;
...
;.include "C:\Program Files (x86)\Labcenter Electronics\Proteus 8 Professional\Tools\AVRASM\APPNOTES\m16def.inc"
...
KeyFind:
	...
	ldi r18,9
	sbis pinc,2
	ldi r18,10	; 10 MEANS A
	sbis pinc,3
	ldi r18,11	;11 MEANS B

	ldi r17,(0<<PC7)|(1<<PC6)|(1<<PC5)|(1<<PC4);
	out portc,r17;
	sbis pinc,0
	ldi r18,12	;12 MEANS C
	sbis pinc,1
	ldi r18,13	;13 MEANS D
	sbis pinc,2
	ldi r18,14	;14 MEANS E
	sbis pinc,3
	ldi r18,15	;15 MEANS F
